...
namespace Students
{
    ...
    partial void DeleteFiliere(Filiere instance);
		...
		public DataClasses2DataContext() : 
				base(global::Students.Properties.Settings.Default.projetConnectionString, mappingSource)
		{
			OnCreated();
		}
	...
	public partial class etudiant : INotifyPropertyChanging, INotifyPropertyChanged , IDataErrorInfo
	{
    ...
    partial void OnimageChanged();
        ...
        public string this[string columnName]
        {
            get
            {
                ...
                {
                    case "cne":
                        if (string.IsNullOrEmpty(cne.ToString())) result = "Champs Obligatoire";
                       break;
                    case "nom":
                        if (string.IsNullOrEmpty(nom)) result = "Champs Obligatoire";
                        break;
                    case "prenom":
                        if (string.IsNullOrEmpty(prenom)) result = "Champs Obligatoire";
                        break;
                    case "telephone":
                        if (string.IsNullOrEmpty(telephone)) result = "Champs Obligatoire";
                        break;
                    case "adresse":
                        if (string.IsNullOrEmpty(adresse)) result = "Champs Obligatoire";
                        break;
                }
